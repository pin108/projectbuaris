...
class GalangDana extends Model
{
    ...
    protected $fillable = ['id_user', 'id_kategoricampaign', 'judul_campaign', 'lokasi_campaign', 'tujuan_campaign', 'targetdonasi_campaign', 'rinciandana_campaign', 'deskripsi_campaign', 'foto_campaign', 'tanggal_mulai', 'tanggal_akhir', 'praturan_campaign'];
