...
class GalangdanakegiatanpantiasuhanController extends Controller
{
    //
    ...
    public function index()
    {
        ...
        if ($user->ktp == null) {
            ...
            return view('pages.galangdana.registergalangdanapantiasuhan', compact('userId', 'kategoriRecords'));
        }
    }
