...
<body class="page__homepage">
	...
	<main class="main">
			...
			<div class="row">
				<div class="col-12 col-lg-6 col-xxl-5 order-2 order-lg-1">
					<div class="d-grid gap-12 w-md-75 w-lg-100">
						<div class="heading-text-1 text-primary">How it works</div>
						<h2 class="heading-section-1 text-dark mb-0">Start find a job you love with us easily</h2>
					</div>
					<!-- /.heading-section -->
					...
					<div class="accordion accordion-number mt-43" id="accordion-how-it-works">
							...
							<button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
								<div class="position-relative d-flex w-100">
									...
									<div class="accordion-content">
										<h2 class="accordion-header" id="headingOne">Complete Profile</h2>
										<div id="collapseOne" class="accordion-collapse collapse" aria-labelledby="headingOne" data-bs-parent="#accordion-how-it-works">
								...
								<div class="accordion-arrow">
									<img src="./assets/icons/chevron-down.svg" class="svg-inject svg-icon" alt="" />
								</div>
							</button>
						</div>
						<!-- /.accordion-item -->
						...
						<div class="accordion-item">
							<button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo" aria-expanded="true" aria-controls="collapseTwo">
								<div class="position-relative d-flex w-100">
									<div class="accordion-number bg-persian-blue bg-opacity-10 text-persian-blue">2</div>
									<div class="accordion-content">
										<h2 class="accordion-header" id="headingTwo">Search Vacancies</h2>
										<div id="collapseTwo" class="accordion-collapse collapse show" aria-labelledby="headingTwo" data-bs-parent="#accordion-how-it-works">
											<div class="accordion-body">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</div>
										</div>
									</div>
								</div>
							...
							<button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseThree" aria-expanded="true" aria-controls="collapseThree">
								<div class="position-relative d-flex w-100">
									...
									<div class="accordion-content">
										...
										<div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#accordion-how-it-works">
											<div class="accordion-body">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</div>
										</div>
									</div>
								</div>
				...
				<div class="col-12 col-lg-6 offset-xxl-1 d-flex align-items-end mb-34 mb-lg-0 order-1 order-lg-2">
					<div class="position-relative">
						<img src="./assets/how-it-work-image.png" class="how-it-work-image-img rounded-40" alt="" />
						<img src="./assets/pages/index/how-it-work/figure-1.svg" class="svg-inject position-absolute how-it-work-figure-1" alt="" />
						<img src="./assets/pages/index/how-it-work/figure-2.svg" class="svg-inject position-absolute how-it-work-figure-2" alt="" />
						<img src="./assets/pages/index/how-it-work/figure-3.svg" class="svg-inject position-absolute how-it-work-figure-3" alt="" />
					</div>
				</div>
				<!-- /.col -->
			</div>
		...
		<div class="container-xxl py-60">
			<div class="row align-items-center">
				...
				<div class="col-4 text-end">
					<span class="ms-auto">
						<a class="text-primary fw-semiBold text-decoration-none" href="/freelancerlist.html">View More</a>
					</span>
				</div>
				<!-- /.col -->
			</div>
			...
			<div class="position-relative profile-card-slider mt-lg-25">
					...
					<div class="swiper-wrapper">
							...
							<div class="profile-card-slide">
								<div class="d-flex">
									<div class="profile-image">
										<img src="./assets/profile-avatar-image-83x83.png" alt="" />
								...
								<div class="profile-action">
									<div class="profile-rating">
										<div class="profile-rating-icon">
											<img src="./assets/icons/star.svg" class="svg-inject svg-icon checked" alt="" />
											<img src="./assets/icons/star.svg" class="svg-inject svg-icon checked" alt="" />
											<img src="./assets/icons/star.svg" class="svg-inject svg-icon checked" alt="" />
											<img src="./assets/icons/star.svg" class="svg-inject svg-icon checked" alt="" />
											<img src="./assets/icons/star.svg" class="svg-inject svg-icon" alt="" />
										</div>
						...
						<div class="swiper-slide">
							<div class="profile-card-slide">
								<div class="d-flex">
									<div class="profile-image">
										<img src="./assets/profile-avatar-image-83x83.png" alt="avatar-2" />
										<div class="profile-online-status online"></div>
									</div>
									<div class="d-flex flex-column justify-content-center">
										<h6 class="profile-name">
						...
						<div class="swiper-slide">
							<div class="profile-card-slide">
								<div class="d-flex">
									<div class="profile-image">
										<img src="./assets/profile-avatar-image-83x83.png" alt="avatar-3" />
						...
						<div class="swiper-slide">
							<div class="profile-card-slide">
								<div class="d-flex">
									<div class="profile-image">
										<img src="./assets/profile-avatar-image-83x83.png" alt="avatar-4" />
										<div class="profile-online-status online"></div>
									</div>
									<div class="d-flex flex-column justify-content-center">
										<h6 class="profile-name">
				...
				<div class="profile-card-button-next">
					<img src="./assets/icons//long-arrow-right.svg" class="svg-inject svg-icon" alt="" />
				</div>
				<!-- /.profile-slider-btn-next -->

				<div class="profile-card-button-prev">
					<img src="./assets/icons//long-arrow-left.svg" class="svg-inject svg-icon" alt="" />
				</div>
		...
		<div class="container-xxl py-60">
			...
			<div class="row">
					...
					<div class="job-card-grid mx-xxl-15">
						<div class="job-dropdown">
							<button class="job-dropdown-btn" type="button" id="job-featured-dropdown" data-bs-display="static" data-bs-toggle="dropdown" aria-expanded="false">
								<img src="./assets/icons/ellipsis.svg" class="svg-inject svg-icon" alt="" />
							</button>
						...
						<div class="job-action">
							...
							<a class="btn btn-apply fw-semiBold py-12 px-43 rounded-pill" href="/jobdetail.html">Apply Now</a>
						</div>
					</div>
					<!-- /.job-card-component -->
				</div>
				...
				<div class="d-none d-xxl-block col-xxl-3 my-12">
					<div class="job-card-grid mx-xxl-15">
						<div class="job-dropdown">
							<button class="job-dropdown-btn" type="button" id="job-featured-dropdown" data-bs-display="static" data-bs-toggle="dropdown" aria-expanded="false">
								<img src="./assets/icons/ellipsis.svg" class="svg-inject" alt="" />
							</button>
							<ul class="dropdown-menu dropdown-menu-end" aria-labelledby="job-featured-dropdown">
								<li><a class="dropdown-item" href="#">Dropdown 1</a></li>
								<li><a class="dropdown-item" href="#">Dropdown 2</a></li>
			...
			<div class="d-flex">
				<a class="btn btn-primary fw-semiBold py-12 px-43 mt-60 mx-auto rounded-pill" href="/jobdetail.html" role="button">View more</a>
			</div>
			<!-- /.btn-more -->
		</div>
		<!-- /.container -->
		...
		<div class="container-xxl py-60">
			...
			<div class="testimonial-slider w-xl-85 mx-auto">
				<div class="testimonial-slider-image">
					...
					<img src="./assets/pages/index/testimonial/figure-1.svg" class="svg-inject position-absolute testimonial-figure-1 text-dark z-index-1" alt="" />

					<img src="./assets/pages/index/testimonial/figure-2.svg" class="svg-inject position-absolute testimonial-figure-2 text-primary z-index-1" alt="" />
				</div>
					...
					<div class="swiper-wrapper">
						...
						<div class="swiper-slide">
							<div class="testimonial-content-item">
								...
								<div class="testimonial-content">
									<p class="testimonial-says">Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium</p>
								</div>
							</div>
						</div>
					</div>
		...
		<div class="container-xxl py-60">
			<div class="counter">
				...
				<figure>
					<img src="./assets/pages/index/counter/figure-1.svg" class="svg-inject position-absolute figure-1 text-ocean-blue text-opacity-33" alt="" />

					<img src="./assets/pages/index/counter/figure-2.svg" class="svg-inject position-absolute figure-2 text-majorelle-blue-200" alt="" />

					<img src="./assets/pages/index/counter/figure-3.svg" class="svg-inject position-absolute figure-3 text-ocean-blue" alt="" />

					<img src="./assets/pages/index/counter/figure-4.svg" class="svg-inject position-absolute figure-4 text-white" alt="" />

					<img src="./assets/pages/index/counter/figure-5.svg" class="svg-inject position-absolute figure-5 text-majorelle-blue-200" alt="" />

					<img src="./assets/pages/index/counter/figure-6.svg" class="svg-inject position-absolute figure-6 text-white text-opacity-17" alt="" />
				</figure>
			</div>
			<!-- /.counter-component -->
		</div>
			...
			<div class="row w-xl-90 w-xxl-75 mx-auto">
				<div class="col-12 col-md-6 col-xl-4 my-12">
					<div class="pricing-card">
						...
						<ul class="pricing-detail">
							<li class="pricing-detail-item">
								<div class="pricing-detail-icon">
									<img src="./assets/icons/check-circle.svg" class="svg-inject svg-icon" alt="" />
								</div>
						...
						<a class="btn btn-apply fw-semiBold py-12 px-43 rounded-pill" href="/applicationform.html">Learn More</a>
					</div>
		...
		<div class="container-xxl py-60">
			<div class="d-grid d-lg-flex gap-34 gap-lg-0 align-items-lg-end mb-60">
				<div class="d-grid gap-12 w-lg-50 w-xl-40">
					...
					<div class="heading-text-2 lh-base text-dark">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua</div>
				</div>
				<!-- /.heading-section -->
				...
				<div class="swiper-wrapper">
					<div class="swiper-slide blog-item">
						<div class="blog-item-inner">
							...
							<div class="blog-thumb">
								...
								<img src="./assets/blog-image-535x540.png" alt="" />
							</div>
					...
					<div class="swiper-slide blog-item">
						<div class="blog-item-inner">
							...
							<div class="blog-thumb">
								<div class="overlay"></div>
								<img src="./assets/blog-image-1020x450.png" alt="" />
							</div>
							<div class="blog-content">
								<div class="blog-meta">
									<a class="blog-meta-link author" href="#">James</a>
								...
								<h2 class="blog-title">
									<a href="/eventlist.html">Let's increase your skills in pandemic with Ziro Workshops 2020</a>
								</h2>
								<div class="blog-summary">
									<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
								</div>
					...
					<div class="swiper-slide blog-item">
						<div class="blog-item-inner">
							...
							<div class="blog-thumb">
								<div class="overlay"></div>
								<img src="./assets/blog-image-535x540.png" alt="thumb-1" />
							</div>
							<div class="blog-content">
								<div class="blog-meta">
									<a class="blog-meta-link author" href="#">James</a>
