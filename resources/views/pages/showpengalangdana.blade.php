...
<main>
    <div class="container">
        <h4 style="text-align: center; margin-top:9%">Yayasan Penggalang Dana</h4>
        <div class="container py-5">
            <div class="row">
                <div class="col-md-6">
                    <img src="./images/yayasanalfo.jpeg" alt="Logo Yayasan" class="img-fluid">
                </div>
            ...
            <div class="row mt-5">
                <div class="col-md-6">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <img src="./images/yayasanalfo.jpeg" alt="Foto Kegiatan 1" class="img-fluid mb-3">
                        </div>
                        <div class="col-md-6">
                            <img src="./images/yayasanalfo1.jpeg" alt="Foto Kegiatan 2" class="img-fluid mb-3">
                        </div>
                        <div class="col-md-6">
                            <img src="./images/yayasanalfo.jpeg" alt="Foto Kegiatan 3" class="img-fluid mb-3">
                        </div>
                        <div class="col-md-6">
                            <img src="./images/yayasanalfo1.jpeg" alt="Foto Kegiatan 4" class="img-fluid mb-3">
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
