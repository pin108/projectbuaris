...
<main>
    <div class="container">
        <img src="./images/infomasibeasiswa.jpg" class="d-block w-100" alt="Sunset Over the City" style="width: 400 px; height:600px" />
    </div>
</main>
@stop
@section('content')
<div class="container">
    <div class="row">
        <div class="col-md-4">
            ...
            <div>
                <a href="#" class="btn btn-danger" style="width: 100%; background-color:red; color:white">Daftar</a>
            </div>
        </div>
        <div class="col-md-8">
            <div>
            ...
            <div>
                <img src="./images/infomasibeasiswa.jpg" class="d-block w-100" alt="Sunset Over the City" style="width: 400 px; height:400px" />
            </div>
            <div>
