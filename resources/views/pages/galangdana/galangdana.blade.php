        ...
        <div class="col-sm-4">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <a href="{{url('index-registerbantuanorangsakit')}}" class="btn btn-primary" style="width: 100%;">Buat galang dana orang sakit</a>
                </div>
            </div>
        </div>
        <div class="col-sm-4">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <a href="{{url('index-registerbantuanbencanaalam')}}" class="btn btn-primary" style="width: 100%;">Buat galang dana bencana alam</a>
                </div>
            </div>
        </div>
        <div class="col-sm-4">
